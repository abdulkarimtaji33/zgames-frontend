  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="rounded-2xl bg-card border border-border p-6 sm:p-8 shadow-2xl">
        ...
        {/* Social login — not wired up to a real OAuth flow yet */}
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button
            ...
            title="Coming soon"
            aria-disabled="true"
            className="flex items-center justify-center gap-2 px-2 sm:px-4 py-2.5 rounded-lg border border-border bg-background-tertiary opacity-50 cursor-not-allowed transition-colors text-sm font-medium"
          >
            ...
            <span className="text-foreground-muted truncate">Google · Coming soon</span>
          </button>
          <button
            type="button"
            disabled
          ...
          >
            ...
            <span className="text-foreground-muted truncate">GitHub · Coming soon</span>
          </button>
        </div>
