    ...
    <div className="w-full max-w-md">
      ...
      <div className="rounded-2xl bg-card border border-border p-6 sm:p-8 shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button className="flex items-center justify-center gap-2 px-2 sm:px-4 py-2.5 rounded-lg border border-border bg-background-tertiary hover:border-border-hover transition-colors text-sm font-medium">
            ...
            <span className="text-foreground-muted truncate">Google</span>
          </button>
          <button className="flex items-center justify-center gap-2 px-2 sm:px-4 py-2.5 rounded-lg border border-border bg-background-tertiary hover:border-border-hover transition-colors text-sm font-medium">
            ...
            <span className="text-foreground-muted truncate">GitHub</span>
          </button>
        </div>
